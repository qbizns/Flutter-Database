...
import (
	...
	"github.com/your-org/pos-backend/internal/service/user_setting"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for UserSettings
type Handler struct {
	service *user_setting.Service
	logger  *logging.Logger
}

// NewHandler creates a new UserSettings handler
func NewHandler(service *user_setting.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateUserSettingsRequest true "UserSettings data"
...
// @Success 200 {object} dto.UserSettingsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "UserSettings ID"
// @Param request body dto.UpdateUserSettingsRequest true "UserSettings data"
// @Success 200 {object} dto.UserSettingsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
