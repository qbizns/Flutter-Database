...
func TestRepository_Create(t *testing.T) {
	repo := budget_line.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestBudgetLines(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestBudgetLinesWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestBudgetLinesRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/budget_lines", strings.NewReader(string(body)))
...
// newTestBudgetLines creates a test BudgetLines entity
func newTestBudgetLines() *budget_line.BudgetLines {
	return &budget_line.BudgetLines{
...
// newTestBudgetLinesWithID creates a test BudgetLines entity with specific ID
func newTestBudgetLinesWithID(id uuid.UUID) *budget_line.BudgetLines {
	entity := newTestBudgetLines()
	entity.ID = id
	return entity
}
