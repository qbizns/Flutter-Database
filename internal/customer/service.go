...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/customer"
	"go.uber.org/zap"
)
...
func NewService(repo *customer.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateCustomersRequest) (*dto.CustomersResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.CustomersResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.CustomersListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.CustomersResponse, len(entities))
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateCustomersRequest) (*dto.CustomersResponse, error) {
...
func (s *Service) entityToResponse(entity *customer.Customers) *dto.CustomersResponse {
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *customer.Customers) error {
