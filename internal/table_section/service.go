...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/table_section"
	"go.uber.org/zap"
)

// Service handles business logic for TableSections
type Service struct {
	repo   *table_section.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new TableSections service
func NewService(repo *table_section.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateTableSectionsRequest) (*dto.TableSectionsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.TableSectionsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.TableSectionsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.TableSectionsResponse, len(entities))
	...
	return &dto.TableSectionsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateTableSectionsRequest) (*dto.TableSectionsResponse, error) {
...
func (s *Service) entityToResponse(entity *table_section.TableSections) *dto.TableSectionsResponse {
	return &dto.TableSectionsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *table_section.TableSections) error {
