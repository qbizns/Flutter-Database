...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/delivery_zone"
	"go.uber.org/zap"
)

// Service handles business logic for DeliveryZones
type Service struct {
	repo   *delivery_zone.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new DeliveryZones service
func NewService(repo *delivery_zone.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateDeliveryZonesRequest) (*dto.DeliveryZonesResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.DeliveryZonesResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.DeliveryZonesListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.DeliveryZonesResponse, len(entities))
	...
	return &dto.DeliveryZonesListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateDeliveryZonesRequest) (*dto.DeliveryZonesResponse, error) {
...
func (s *Service) entityToResponse(entity *delivery_zone.DeliveryZones) *dto.DeliveryZonesResponse {
	return &dto.DeliveryZonesResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *delivery_zone.DeliveryZones) error {
