...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/loyalty_reward"
	"go.uber.org/zap"
)

// Service handles business logic for LoyaltyRewards
type Service struct {
	repo   *loyalty_reward.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new LoyaltyRewards service
func NewService(repo *loyalty_reward.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateLoyaltyRewardsRequest) (*dto.LoyaltyRewardsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.LoyaltyRewardsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.LoyaltyRewardsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.LoyaltyRewardsResponse, len(entities))
	...
	return &dto.LoyaltyRewardsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateLoyaltyRewardsRequest) (*dto.LoyaltyRewardsResponse, error) {
...
func (s *Service) entityToResponse(entity *loyalty_reward.LoyaltyRewards) *dto.LoyaltyRewardsResponse {
	return &dto.LoyaltyRewardsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *loyalty_reward.LoyaltyRewards) error {
