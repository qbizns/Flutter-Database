...
import (
	...
	"github.com/your-org/pos-backend/internal/service/pos_error_log"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for PosErrorLogs
type Handler struct {
	service *pos_error_log.Service
	logger  *logging.Logger
}

// NewHandler creates a new PosErrorLogs handler
func NewHandler(service *pos_error_log.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreatePosErrorLogsRequest true "PosErrorLogs data"
// @Success 201 {object} dto.PosErrorLogsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreatePosErrorLogsRequest
...
// @Success 200 {object} dto.PosErrorLogsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.PosErrorLogsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "PosErrorLogs ID"
// @Param request body dto.UpdatePosErrorLogsRequest true "PosErrorLogs data"
// @Success 200 {object} dto.PosErrorLogsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdatePosErrorLogsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
