...
import (
	...
	"github.com/your-org/pos-backend/internal/service/order_item"
	"go.uber.org/zap"
)
...
func NewHandler(service *order_item.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateOrderItemsRequest true "OrderItems data"
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateOrderItemsRequest
...
// @Success 200 {object} dto.OrderItemsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.OrderItemsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "OrderItems ID"
// @Param request body dto.UpdateOrderItemsRequest true "OrderItems data"
// @Success 200 {object} dto.OrderItemsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
