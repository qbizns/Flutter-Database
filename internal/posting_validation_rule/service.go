...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/posting_validation_rule"
	"go.uber.org/zap"
)

// Service handles business logic for PostingValidationRules
type Service struct {
	repo   *posting_validation_rule.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new PostingValidationRules service
func NewService(repo *posting_validation_rule.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreatePostingValidationRulesRequest) (*dto.PostingValidationRulesResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.PostingValidationRulesResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.PostingValidationRulesListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.PostingValidationRulesResponse, len(entities))
	...
	return &dto.PostingValidationRulesListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdatePostingValidationRulesRequest) (*dto.PostingValidationRulesResponse, error) {
...
func (s *Service) entityToResponse(entity *posting_validation_rule.PostingValidationRules) *dto.PostingValidationRulesResponse {
	return &dto.PostingValidationRulesResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *posting_validation_rule.PostingValidationRules) error {
