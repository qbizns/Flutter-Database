...
import (
	...
	"github.com/your-org/pos-backend/internal/service/pos_posting_audit"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for PosPostingAudit
type Handler struct {
	service *pos_posting_audit.Service
	logger  *logging.Logger
}

// NewHandler creates a new PosPostingAudit handler
func NewHandler(service *pos_posting_audit.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreatePosPostingAuditRequest true "PosPostingAudit data"
// @Success 201 {object} dto.PosPostingAuditResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreatePosPostingAuditRequest
...
// @Success 200 {object} dto.PosPostingAuditResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.PosPostingAuditListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "PosPostingAudit ID"
// @Param request body dto.UpdatePosPostingAuditRequest true "PosPostingAudit data"
// @Success 200 {object} dto.PosPostingAuditResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdatePosPostingAuditRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
