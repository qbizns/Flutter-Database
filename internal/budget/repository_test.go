...
func TestRepository_Create(t *testing.T) {
	repo := budget.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestBudgets(testOrgID),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestBudgetsWithID(uuid.New(), testOrgID),
			wantErr: true,
		},
	}
...
func TestRepository_Update(t *testing.T) {
	...
	entity.BudgetCode = "updated_value"
	...
	assert.Equal(t, "updated_value", updated.BudgetCode)
...
func TestRepository_ListByOrganization(t *testing.T) {
	...
	otherOrgID := uuid.New()
	for i := 0; i < 2; i++ {
		entity := newTestBudgets(otherOrgID)
		err := repo.Create(ctx, tx, entity)
		require.NoError(t, err)
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestBudgetsRequest(testOrgID)
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestBudgetsRequest(testOrgID)
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/organizations/"+testOrgID.String()+"/budgets", strings.NewReader(string(body)))
...
// newTestBudgets creates a test Budgets entity
func newTestBudgets(orgID uuid.UUID) *budget.Budgets {
...
// newTestBudgetsWithID creates a test Budgets entity with specific ID
func newTestBudgetsWithID(id uuid.UUID, orgID uuid.UUID) *budget.Budgets {
	entity := newTestBudgets(orgID)
	entity.ID = id
	return entity
}
