...
import (
	...
	"github.com/your-org/pos-backend/internal/service/employee_schedule"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for EmployeeSchedules
type Handler struct {
	service *employee_schedule.Service
	logger  *logging.Logger
}

// NewHandler creates a new EmployeeSchedules handler
func NewHandler(service *employee_schedule.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateEmployeeSchedulesRequest true "EmployeeSchedules data"
// @Success 201 {object} dto.EmployeeSchedulesResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateEmployeeSchedulesRequest
...
// @Success 200 {object} dto.EmployeeSchedulesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.EmployeeSchedulesListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "EmployeeSchedules ID"
// @Param request body dto.UpdateEmployeeSchedulesRequest true "EmployeeSchedules data"
// @Success 200 {object} dto.EmployeeSchedulesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateEmployeeSchedulesRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
