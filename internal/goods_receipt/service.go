...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/goods_receipt"
	"go.uber.org/zap"
)

// Service handles business logic for GoodsReceipts
type Service struct {
	repo   *goods_receipt.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new GoodsReceipts service
func NewService(repo *goods_receipt.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateGoodsReceiptsRequest) (*dto.GoodsReceiptsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.GoodsReceiptsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.GoodsReceiptsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.GoodsReceiptsResponse, len(entities))
	...
	return &dto.GoodsReceiptsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateGoodsReceiptsRequest) (*dto.GoodsReceiptsResponse, error) {
...
func (s *Service) entityToResponse(entity *goods_receipt.GoodsReceipts) *dto.GoodsReceiptsResponse {
	return &dto.GoodsReceiptsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *goods_receipt.GoodsReceipts) error {
