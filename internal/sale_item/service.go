...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/sale_item"
	"go.uber.org/zap"
)

// Service handles business logic for SaleItems
type Service struct {
	repo   *sale_item.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new SaleItems service
func NewService(repo *sale_item.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateSaleItemsRequest) (*dto.SaleItemsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.SaleItemsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.SaleItemsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.SaleItemsResponse, len(entities))
	...
	return &dto.SaleItemsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateSaleItemsRequest) (*dto.SaleItemsResponse, error) {
...
func (s *Service) entityToResponse(entity *sale_item.SaleItems) *dto.SaleItemsResponse {
	return &dto.SaleItemsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *sale_item.SaleItems) error {
