...
import (
	...
	"github.com/your-org/pos-backend/internal/service/customer_payment"
	"go.uber.org/zap"
)
...
func NewHandler(service *customer_payment.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateCustomerPaymentsRequest true "CustomerPayments data"
// @Success 201 {object} dto.CustomerPaymentsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateCustomerPaymentsRequest
...
// @Success 200 {object} dto.CustomerPaymentsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.CustomerPaymentsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "CustomerPayments ID"
// @Param request body dto.UpdateCustomerPaymentsRequest true "CustomerPayments data"
// @Success 200 {object} dto.CustomerPaymentsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateCustomerPaymentsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
