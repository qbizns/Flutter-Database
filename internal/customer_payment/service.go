...
import (
	...
	"github.com/your-org/pos-backend/internal/dto/customer_payment"
	"github.com/your-org/pos-backend/internal/logging"
	"github.com/your-org/pos-backend/internal/repository/customer_payment"
	"go.uber.org/zap"
)

// Service handles business logic for CustomerPayments
type Service struct {
	repo   *customer_payment.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new CustomerPayments service
func NewService(repo *customer_payment.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateCustomerPaymentsRequest) (*dto.CustomerPaymentsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.CustomerPaymentsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.CustomerPaymentsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.CustomerPaymentsResponse, len(entities))
	...
	return &dto.CustomerPaymentsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateCustomerPaymentsRequest) (*dto.CustomerPaymentsResponse, error) {
...
func (s *Service) entityToResponse(entity *customer_payment.CustomerPayments) *dto.CustomerPaymentsResponse {
	return &dto.CustomerPaymentsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *customer_payment.CustomerPayments) error {
