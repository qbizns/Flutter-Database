...
import (
	...
	"github.com/your-org/pos-backend/internal/service/uom_conversion"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for UomConversions
type Handler struct {
	service *uom_conversion.Service
	logger  *logging.Logger
}

// NewHandler creates a new UomConversions handler
func NewHandler(service *uom_conversion.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateUomConversionsRequest true "UomConversions data"
// @Success 201 {object} dto.UomConversionsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateUomConversionsRequest
...
// @Success 200 {object} dto.UomConversionsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.UomConversionsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "UomConversions ID"
// @Param request body dto.UpdateUomConversionsRequest true "UomConversions data"
// @Success 200 {object} dto.UomConversionsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateUomConversionsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
