...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/inventory_transfer"
	"go.uber.org/zap"
)

// Service handles business logic for InventoryTransfers
type Service struct {
	repo   *inventory_transfer.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new InventoryTransfers service
func NewService(repo *inventory_transfer.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateInventoryTransfersRequest) (*dto.InventoryTransfersResponse, error) {
	...
	entity := &inventory_transfer.InventoryTransfers{
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.InventoryTransfersResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.InventoryTransfersListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.InventoryTransfersResponse, len(entities))
	...
	return &dto.InventoryTransfersListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateInventoryTransfersRequest) (*dto.InventoryTransfersResponse, error) {
...
func (s *Service) entityToResponse(entity *inventory_transfer.InventoryTransfers) *dto.InventoryTransfersResponse {
	return &dto.InventoryTransfersResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *inventory_transfer.InventoryTransfers) error {
