...
import (
	...
	"github.com/your-org/pos-backend/internal/service/staff_commission"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for StaffCommissions
type Handler struct {
	service *staff_commission.Service
	logger  *logging.Logger
}

// NewHandler creates a new StaffCommissions handler
func NewHandler(service *staff_commission.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateStaffCommissionsRequest true "StaffCommissions data"
// @Success 201 {object} dto.StaffCommissionsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateStaffCommissionsRequest
...
// @Success 200 {object} dto.StaffCommissionsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.StaffCommissionsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "StaffCommissions ID"
// @Param request body dto.UpdateStaffCommissionsRequest true "StaffCommissions data"
// @Success 200 {object} dto.StaffCommissionsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateStaffCommissionsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
