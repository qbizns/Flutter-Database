...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/sale_return_item"
	"go.uber.org/zap"
)

// Service handles business logic for SaleReturnItems
type Service struct {
	repo   *sale_return_item.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new SaleReturnItems service
func NewService(repo *sale_return_item.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateSaleReturnItemsRequest) (*dto.SaleReturnItemsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.SaleReturnItemsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.SaleReturnItemsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.SaleReturnItemsResponse, len(entities))
	...
	return &dto.SaleReturnItemsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateSaleReturnItemsRequest) (*dto.SaleReturnItemsResponse, error) {
...
func (s *Service) entityToResponse(entity *sale_return_item.SaleReturnItems) *dto.SaleReturnItemsResponse {
	return &dto.SaleReturnItemsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *sale_return_item.SaleReturnItems) error {
