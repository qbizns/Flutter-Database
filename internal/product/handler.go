...
import (
	...
	"github.com/your-org/pos-backend/internal/service/product"
	"go.uber.org/zap"
)
...
func NewHandler(service *product.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateProductsRequest true "Products data"
// @Success 201 {object} dto.ProductsResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "Products ID"
// @Param request body dto.UpdateProductsRequest true "Products data"
// @Success 200 {object} dto.ProductsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateProductsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
