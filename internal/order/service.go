...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/order"
	"go.uber.org/zap"
)
...
func NewService(repo *order.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateOrdersRequest) (*dto.OrdersResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.OrdersResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.OrdersListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.OrdersResponse, len(entities))
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateOrdersRequest) (*dto.OrdersResponse, error) {
...
func (s *Service) entityToResponse(entity *order.Orders) *dto.OrdersResponse {
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *order.Orders) error {
