package fiscal_position_tax_mapping_test
...
func TestRepository_Create(t *testing.T) {
	repo := fiscal_position_tax_mapping.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestFiscalPositionTaxMappings(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestFiscalPositionTaxMappingsWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestService_Create(t *testing.T) {
	...
	req := &dto.CreateFiscalPositionTaxMappingsRequest{
		...
		FiscalPositionId: uuid.New(),
		
		
		
		
		SourceTaxId: uuid.New(),
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestFiscalPositionTaxMappingsRequest()
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestFiscalPositionTaxMappingsRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/fiscal_position_tax_mappings", strings.NewReader(string(body)))
...
// newTestFiscalPositionTaxMappings creates a test FiscalPositionTaxMappings entity
func newTestFiscalPositionTaxMappings() *fiscal_position_tax_mapping.FiscalPositionTaxMappings {
	return &fiscal_position_tax_mapping.FiscalPositionTaxMappings{
...
// newTestFiscalPositionTaxMappingsWithID creates a test FiscalPositionTaxMappings entity with specific ID
func newTestFiscalPositionTaxMappingsWithID(id uuid.UUID) *fiscal_position_tax_mapping.FiscalPositionTaxMappings {
	entity := newTestFiscalPositionTaxMappings()
	entity.ID = id
	return entity
}
