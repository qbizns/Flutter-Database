...
import (
	...
	"github.com/your-org/pos-backend/internal/dto/price_list"
	"github.com/your-org/pos-backend/internal/logging"
	"github.com/your-org/pos-backend/internal/repository/price_list"
	"go.uber.org/zap"
)

// Service handles business logic for PriceLists
type Service struct {
	repo   *price_list.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new PriceLists service
func NewService(repo *price_list.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreatePriceListsRequest) (*dto.PriceListsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.PriceListsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.PriceListsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.PriceListsResponse, len(entities))
	...
	return &dto.PriceListsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdatePriceListsRequest) (*dto.PriceListsResponse, error) {
...
func (s *Service) entityToResponse(entity *price_list.PriceLists) *dto.PriceListsResponse {
	return &dto.PriceListsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *price_list.PriceLists) error {
