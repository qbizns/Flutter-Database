...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/deferred_revenue_contract"
	"go.uber.org/zap"
)

// Service handles business logic for DeferredRevenueContracts
type Service struct {
	repo   *deferred_revenue_contract.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new DeferredRevenueContracts service
func NewService(repo *deferred_revenue_contract.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateDeferredRevenueContractsRequest) (*dto.DeferredRevenueContractsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.DeferredRevenueContractsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.DeferredRevenueContractsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.DeferredRevenueContractsResponse, len(entities))
	...
	return &dto.DeferredRevenueContractsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateDeferredRevenueContractsRequest) (*dto.DeferredRevenueContractsResponse, error) {
...
func (s *Service) entityToResponse(entity *deferred_revenue_contract.DeferredRevenueContracts) *dto.DeferredRevenueContractsResponse {
	return &dto.DeferredRevenueContractsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *deferred_revenue_contract.DeferredRevenueContracts) error {
