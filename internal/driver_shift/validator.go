...
// Validator handles DriverShifts validation logic
type Validator struct {
	repo *Repository
}

// NewValidator creates a new DriverShifts validator
...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *dto.CreateDriverShiftsRequest) error {
	// Basic validation
	...
	// Validate TotalDistanceKm
	
	
	
	// Validate TotalEarnings
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *dto.UpdateDriverShiftsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
	...
	// Validate ShiftDate if provided
	...
	// Validate ActualStartTime if provided
	
	
	
	// Validate ActualEndTime if provided
	...
	// Validate TotalBreakMinutes if provided
	...
	// Validate TotalDistanceKm if provided
	
	
	
	// Validate TotalEarnings if provided
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *dto.CreateDriverShiftsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *dto.CreateDriverShiftsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *DriverShifts, req *dto.UpdateDriverShiftsRequest) error {
...
func (v *Validator) validateCanDelete(ctx context.Context, tx pgx.Tx, entity *DriverShifts) error {
