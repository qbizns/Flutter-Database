...
import (
	...
	"github.com/your-org/pos-backend/internal/service/account_subtype"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for AccountSubtypes
type Handler struct {
	service *account_subtype.Service
	logger  *logging.Logger
}

// NewHandler creates a new AccountSubtypes handler
func NewHandler(service *account_subtype.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateAccountSubtypesRequest true "AccountSubtypes data"
// @Success 201 {object} dto.AccountSubtypesResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateAccountSubtypesRequest
...
// @Success 200 {object} dto.AccountSubtypesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.AccountSubtypesListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "AccountSubtypes ID"
// @Param request body dto.UpdateAccountSubtypesRequest true "AccountSubtypes data"
// @Success 200 {object} dto.AccountSubtypesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateAccountSubtypesRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
