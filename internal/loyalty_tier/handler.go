...
import (
	...
	"github.com/your-org/pos-backend/internal/service/loyalty_tier"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for LoyaltyTiers
type Handler struct {
	service *loyalty_tier.Service
	logger  *logging.Logger
}

// NewHandler creates a new LoyaltyTiers handler
func NewHandler(service *loyalty_tier.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateLoyaltyTiersRequest true "LoyaltyTiers data"
// @Success 201 {object} dto.LoyaltyTiersResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateLoyaltyTiersRequest
...
// @Success 200 {object} dto.LoyaltyTiersResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.LoyaltyTiersListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "LoyaltyTiers ID"
// @Param request body dto.UpdateLoyaltyTiersRequest true "LoyaltyTiers data"
// @Success 200 {object} dto.LoyaltyTiersResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateLoyaltyTiersRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
