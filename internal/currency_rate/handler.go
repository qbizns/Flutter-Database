...
import (
	...
	"github.com/your-org/pos-backend/internal/service/currency_rate"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for CurrencyRates
type Handler struct {
	service *currency_rate.Service
	logger  *logging.Logger
}

// NewHandler creates a new CurrencyRates handler
func NewHandler(service *currency_rate.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateCurrencyRatesRequest true "CurrencyRates data"
// @Success 201 {object} dto.CurrencyRatesResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateCurrencyRatesRequest
...
// @Success 200 {object} dto.CurrencyRatesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.CurrencyRatesListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "CurrencyRates ID"
// @Param request body dto.UpdateCurrencyRatesRequest true "CurrencyRates data"
// @Success 200 {object} dto.CurrencyRatesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateCurrencyRatesRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
