...
func TestRepository_Create(t *testing.T) {
	repo := organization.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestOrganizations(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestOrganizationsWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestOrganizationsRequest()
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestOrganizationsRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/organizations", strings.NewReader(string(body)))
...
// newTestOrganizations creates a test Organizations entity
func newTestOrganizations() *organization.Organizations {
...
// newTestOrganizationsWithID creates a test Organizations entity with specific ID
func newTestOrganizationsWithID(id uuid.UUID) *organization.Organizations {
	entity := newTestOrganizations()
	entity.ID = id
	return entity
}
