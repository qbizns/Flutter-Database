...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/journal_entry_line"
	"go.uber.org/zap"
)

// Service handles business logic for JournalEntryLines
type Service struct {
	repo   *journal_entry_line.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new JournalEntryLines service
func NewService(repo *journal_entry_line.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateJournalEntryLinesRequest) (*dto.JournalEntryLinesResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.JournalEntryLinesResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.JournalEntryLinesListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.JournalEntryLinesResponse, len(entities))
	...
	return &dto.JournalEntryLinesListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateJournalEntryLinesRequest) (*dto.JournalEntryLinesResponse, error) {
...
func (s *Service) entityToResponse(entity *journal_entry_line.JournalEntryLines) *dto.JournalEntryLinesResponse {
	return &dto.JournalEntryLinesResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *journal_entry_line.JournalEntryLines) error {
