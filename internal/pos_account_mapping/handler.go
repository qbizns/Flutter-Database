...
import (
	...
	"github.com/your-org/pos-backend/internal/service/pos_account_mapping"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for PosAccountMappings
type Handler struct {
	service *pos_account_mapping.Service
	logger  *logging.Logger
}

// NewHandler creates a new PosAccountMappings handler
func NewHandler(service *pos_account_mapping.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreatePosAccountMappingsRequest true "PosAccountMappings data"
// @Success 201 {object} dto.PosAccountMappingsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreatePosAccountMappingsRequest
...
// @Success 200 {object} dto.PosAccountMappingsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.PosAccountMappingsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "PosAccountMappings ID"
// @Param request body dto.UpdatePosAccountMappingsRequest true "PosAccountMappings data"
// @Success 200 {object} dto.PosAccountMappingsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdatePosAccountMappingsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
