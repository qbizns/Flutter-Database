...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/cash_drawer"
	"go.uber.org/zap"
)

// Service handles business logic for CashDrawers
type Service struct {
	repo   *cash_drawer.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new CashDrawers service
func NewService(repo *cash_drawer.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateCashDrawersRequest) (*dto.CashDrawersResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.CashDrawersResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.CashDrawersListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.CashDrawersResponse, len(entities))
	...
	return &dto.CashDrawersListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateCashDrawersRequest) (*dto.CashDrawersResponse, error) {
...
func (s *Service) entityToResponse(entity *cash_drawer.CashDrawers) *dto.CashDrawersResponse {
	return &dto.CashDrawersResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *cash_drawer.CashDrawers) error {
