...
import (
	...
	"github.com/your-org/pos-backend/internal/service/bank_statement"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for BankStatements
type Handler struct {
	service *bank_statement.Service
	logger  *logging.Logger
}

// NewHandler creates a new BankStatements handler
func NewHandler(service *bank_statement.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateBankStatementsRequest true "BankStatements data"
// @Success 201 {object} dto.BankStatementsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateBankStatementsRequest
...
// @Success 200 {object} dto.BankStatementsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.BankStatementsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "BankStatements ID"
// @Param request body dto.UpdateBankStatementsRequest true "BankStatements data"
// @Success 200 {object} dto.BankStatementsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateBankStatementsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
