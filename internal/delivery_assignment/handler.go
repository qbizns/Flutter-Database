...
import (
	...
	"github.com/your-org/pos-backend/internal/service/delivery_assignment"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for DeliveryAssignments
type Handler struct {
	service *delivery_assignment.Service
	logger  *logging.Logger
}

// NewHandler creates a new DeliveryAssignments handler
func NewHandler(service *delivery_assignment.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateDeliveryAssignmentsRequest true "DeliveryAssignments data"
// @Success 201 {object} dto.DeliveryAssignmentsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateDeliveryAssignmentsRequest
...
// @Success 200 {object} dto.DeliveryAssignmentsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.DeliveryAssignmentsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "DeliveryAssignments ID"
// @Param request body dto.UpdateDeliveryAssignmentsRequest true "DeliveryAssignments data"
// @Success 200 {object} dto.DeliveryAssignmentsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateDeliveryAssignmentsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
