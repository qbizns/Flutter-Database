...
func TestRepository_Create(t *testing.T) {
	repo := supplier.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestSuppliers(testOrgID),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestSuppliersWithID(uuid.New(), testOrgID),
			wantErr: true,
		},
	}
...
func TestRepository_Update(t *testing.T) {
	...
	entity.SupplierCode = "updated_value"
	...
	assert.Equal(t, "updated_value", updated.SupplierCode)
...
func TestRepository_ListByOrganization(t *testing.T) {
	...
	otherOrgID := uuid.New()
	for i := 0; i < 2; i++ {
		entity := newTestSuppliers(otherOrgID)
		err := repo.Create(ctx, tx, entity)
		require.NoError(t, err)
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestSuppliersRequest(testOrgID)
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestSuppliersRequest(testOrgID)
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/organizations/"+testOrgID.String()+"/suppliers", strings.NewReader(string(body)))
...
// newTestSuppliers creates a test Suppliers entity
func newTestSuppliers(orgID uuid.UUID) *supplier.Suppliers {
...
// newTestSuppliersWithID creates a test Suppliers entity with specific ID
func newTestSuppliersWithID(id uuid.UUID, orgID uuid.UUID) *supplier.Suppliers {
	entity := newTestSuppliers(orgID)
	entity.ID = id
	return entity
}
