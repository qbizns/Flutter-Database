...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/inventory_valuation_setting"
	"go.uber.org/zap"
)

// Service handles business logic for InventoryValuationSettings
type Service struct {
	repo   *inventory_valuation_setting.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new InventoryValuationSettings service
func NewService(repo *inventory_valuation_setting.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateInventoryValuationSettingsRequest) (*dto.InventoryValuationSettingsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.InventoryValuationSettingsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.InventoryValuationSettingsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.InventoryValuationSettingsResponse, len(entities))
	...
	return &dto.InventoryValuationSettingsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateInventoryValuationSettingsRequest) (*dto.InventoryValuationSettingsResponse, error) {
...
func (s *Service) entityToResponse(entity *inventory_valuation_setting.InventoryValuationSettings) *dto.InventoryValuationSettingsResponse {
	return &dto.InventoryValuationSettingsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *inventory_valuation_setting.InventoryValuationSettings) error {
