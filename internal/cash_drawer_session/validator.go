...
// Validator handles CashDrawerSessions validation logic
type Validator struct {
	repo *Repository
}

// NewValidator creates a new CashDrawerSessions validator
...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *dto.CreateCashDrawerSessionsRequest) error {
	// Basic validation
	...
	// Validate OpeningAmount
	
	
	
	// Validate ClosingAmount
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *dto.UpdateCashDrawerSessionsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
	...
	// Validate OpeningAmount if provided
	
	
	
	// Validate ClosingAmount if provided
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *dto.CreateCashDrawerSessionsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *dto.CreateCashDrawerSessionsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *CashDrawerSessions, req *dto.UpdateCashDrawerSessionsRequest) error {
...
func (v *Validator) validateCanDelete(ctx context.Context, tx pgx.Tx, entity *CashDrawerSessions) error {
