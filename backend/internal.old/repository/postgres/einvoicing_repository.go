...
// Wrapper methods for repository interface (implementing both repo interfaces)

func (r *EInvoicingRepository) Create(ctx context.Context, seq *einvoicing.DocumentSequence) error {
	return r.CreateSequence(ctx, seq)
}

func (r *EInvoicingRepository) Get(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*einvoicing.DocumentSequence, error) {
	return r.GetSequence(ctx, orgID, id)
}

func (r *EInvoicingRepository) GetByDocumentType(ctx context.Context, orgID uuid.UUID, documentType string, locationID *uuid.UUID) (*einvoicing.DocumentSequence, error) {
	return r.GetByDocumentType(ctx, orgID, documentType, locationID)
}

func (r *EInvoicingRepository) List(ctx context.Context, orgID uuid.UUID, filters einvoicing.DocumentSequenceFilters) ([]einvoicing.DocumentSequence, error) {
	return r.ListSequences(ctx, orgID, filters)
}

func (r *EInvoicingRepository) Count(ctx context.Context, orgID uuid.UUID, filters einvoicing.DocumentSequenceFilters) (int64, error) {
	return int64(len([]einvoicing.DocumentSequence{})), nil // Implement if needed
}

func (r *EInvoicingRepository) Update(ctx context.Context, seq *einvoicing.DocumentSequence) error {
	return r.UpdateSequence(ctx, seq)
}

func (r *EInvoicingRepository) Delete(ctx context.Context, orgID uuid.UUID, id uuid.UUID) error {
	return r.DeleteSequence(ctx, orgID, id)
}

func (r *EInvoicingRepository) GetNextNumber(ctx context.Context, orgID uuid.UUID, documentType string, locationID *uuid.UUID) (string, error) {
	return r.GetNextNumber(ctx, orgID, documentType, locationID)
}

func (r *EInvoicingRepository) PreviewNumber(ctx context.Context, orgID uuid.UUID, documentType string, locationID *uuid.UUID) (string, error) {
	return r.PreviewNumber(ctx, orgID, documentType, locationID)
}

func (r *EInvoicingRepository) ResetSequence(ctx context.Context, orgID uuid.UUID, documentType string, resetTo int64, locationID *uuid.UUID) error {
	return r.ResetSequence(ctx, orgID, documentType, resetTo, locationID)
}
