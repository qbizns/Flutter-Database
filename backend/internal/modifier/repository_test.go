...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateModifiersRequest{
...
func newTestModifiersRequest(orgID uuid.UUID) *CreateModifiersRequest {
	return &CreateModifiersRequest{
