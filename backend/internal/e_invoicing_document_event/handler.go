...
// @Param request body CreateEInvoicingDocumentEventsRequest true "EInvoicingDocumentEvents data"
// @Success 201 {object} EInvoicingDocumentEventsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateEInvoicingDocumentEventsRequest
...
// @Success 200 {object} EInvoicingDocumentEventsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} EInvoicingDocumentEventsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "EInvoicingDocumentEvents ID"
// @Param request body UpdateEInvoicingDocumentEventsRequest true "EInvoicingDocumentEvents data"
// @Success 200 {object} EInvoicingDocumentEventsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateEInvoicingDocumentEventsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
