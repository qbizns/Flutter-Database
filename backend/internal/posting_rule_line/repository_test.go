package posting_rule_line_test
...
func TestRepository_Create(t *testing.T) {
	repo := posting_rule_line.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestPostingRuleLines(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestPostingRuleLinesWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestPostingRuleLinesRequest()
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestPostingRuleLinesRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/posting_rule_lines", strings.NewReader(string(body)))
...
// newTestPostingRuleLines creates a test PostingRuleLines entity
func newTestPostingRuleLines() *posting_rule_line.PostingRuleLines {
	return &posting_rule_line.PostingRuleLines{
		...
		AccountSource: "test_account_source",
		...
		AmountSource: "test_amount_source",
		...
		(accountSource: "test_(account_source",
		...
		(amountSource: "test_(amount_source",
...
// newTestPostingRuleLinesWithID creates a test PostingRuleLines entity with specific ID
func newTestPostingRuleLinesWithID(id uuid.UUID) *posting_rule_line.PostingRuleLines {
	entity := newTestPostingRuleLines()
	entity.ID = id
	return entity
}
