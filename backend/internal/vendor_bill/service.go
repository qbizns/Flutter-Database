...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/vendor_bill"
	"go.uber.org/zap"
)

// Service handles business logic for VendorBills
type Service struct {
	repo   *vendor_bill.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new VendorBills service
func NewService(repo *vendor_bill.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateVendorBillsRequest) (*dto.VendorBillsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.VendorBillsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.VendorBillsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.VendorBillsResponse, len(entities))
	...
	return &dto.VendorBillsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateVendorBillsRequest) (*dto.VendorBillsResponse, error) {
...
func (s *Service) entityToResponse(entity *vendor_bill.VendorBills) *dto.VendorBillsResponse {
	return &dto.VendorBillsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *vendor_bill.VendorBills) error {
