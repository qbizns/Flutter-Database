...
func TestService_Update(t *testing.T) {
	...
	updateReq := &UpdateVendorBillsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateVendorBillsRequest{
...
func newTestVendorBillsRequest(orgID uuid.UUID) *CreateVendorBillsRequest {
	return &CreateVendorBillsRequest{
