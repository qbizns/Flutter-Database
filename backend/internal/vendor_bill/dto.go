...
// VendorBillsResponse represents a vendor_bills response
type VendorBillsResponse struct {
...
// CreateVendorBillsRequest represents a request to create a vendor_bills
type CreateVendorBillsRequest struct {
...
func (r *CreateVendorBillsRequest) Validate() error {
	
	if r.BillNumber == "" {
		return fmt.Errorf("bill_number is required")
	}
...
// UpdateVendorBillsRequest represents a request to update a vendor_bills
type UpdateVendorBillsRequest struct {
	
	BillNumber *string `json:"bill_number,omitempty" validate:"omitempty,required"`
	
	VendorBillNumber *string `json:"vendor_bill_number,omitempty"`
	
	SupplierId *uuid.UUID `json:"supplier_id,omitempty" validate:"omitempty,required"`
	
	BillDate *time.Time `json:"bill_date,omitempty" validate:"omitempty,required"`
...
func (r *UpdateVendorBillsRequest) Validate() error {
...
// VendorBillsListResponse represents a paginated list of vendor_bills records
type VendorBillsListResponse struct {
	Items      []*VendorBillsResponse `json:"items"`
