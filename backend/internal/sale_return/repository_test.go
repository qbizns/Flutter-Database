...
func TestRepository_Create(t *testing.T) {
	repo := sale_return.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestSaleReturns(testOrgID),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestSaleReturnsWithID(uuid.New(), testOrgID),
			wantErr: true,
		},
	}
...
func TestRepository_Update(t *testing.T) {
	...
	entity.ReturnNumber = "updated_value"
	...
	assert.Equal(t, "updated_value", updated.ReturnNumber)
...
func TestRepository_ListByOrganization(t *testing.T) {
	...
	otherOrgID := uuid.New()
	for i := 0; i < 2; i++ {
		entity := newTestSaleReturns(otherOrgID)
		err := repo.Create(ctx, tx, entity)
		require.NoError(t, err)
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestSaleReturnsRequest(testOrgID)
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestSaleReturnsRequest(testOrgID)
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/organizations/"+testOrgID.String()+"/sale_returns", strings.NewReader(string(body)))
...
// newTestSaleReturns creates a test SaleReturns entity
func newTestSaleReturns(orgID uuid.UUID) *sale_return.SaleReturns {
	return &sale_return.SaleReturns{
...
// newTestSaleReturnsWithID creates a test SaleReturns entity with specific ID
func newTestSaleReturnsWithID(id uuid.UUID, orgID uuid.UUID) *sale_return.SaleReturns {
	entity := newTestSaleReturns(orgID)
	entity.ID = id
	return entity
}
