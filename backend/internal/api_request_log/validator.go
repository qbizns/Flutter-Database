...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *CreateApiRequestLogsRequest) error {
	// Basic validation
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *UpdateApiRequestLogsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *CreateApiRequestLogsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *CreateApiRequestLogsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *ApiRequestLogs, req *UpdateApiRequestLogsRequest) error {
