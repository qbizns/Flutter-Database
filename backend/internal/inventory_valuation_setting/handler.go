...
// @Param request body CreateInventoryValuationSettingsRequest true "InventoryValuationSettings data"
// @Success 201 {object} InventoryValuationSettingsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateInventoryValuationSettingsRequest
...
// @Success 200 {object} InventoryValuationSettingsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} InventoryValuationSettingsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "InventoryValuationSettings ID"
// @Param request body UpdateInventoryValuationSettingsRequest true "InventoryValuationSettings data"
// @Success 200 {object} InventoryValuationSettingsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateInventoryValuationSettingsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
