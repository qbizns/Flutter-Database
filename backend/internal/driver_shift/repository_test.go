...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateDriverShiftsRequest{
...
func newTestDriverShiftsRequest(orgID uuid.UUID) *CreateDriverShiftsRequest {
	return &CreateDriverShiftsRequest{
