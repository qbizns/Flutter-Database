...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *CreateInvoicePaymentSchedulesRequest) error {
	// Basic validation
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *UpdateInvoicePaymentSchedulesRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *CreateInvoicePaymentSchedulesRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *CreateInvoicePaymentSchedulesRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *InvoicePaymentSchedules, req *UpdateInvoicePaymentSchedulesRequest) error {
