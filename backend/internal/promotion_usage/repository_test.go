...
func TestService_Create(t *testing.T) {
	...
	req := &CreatePromotionUsageRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreatePromotionUsageRequest{
	...
	var resp PromotionUsageResponse
...
func newTestPromotionUsageRequest(orgID uuid.UUID) *CreatePromotionUsageRequest {
	return &CreatePromotionUsageRequest{
