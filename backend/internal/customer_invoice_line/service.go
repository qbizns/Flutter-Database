...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/customer_invoice_line"
	"go.uber.org/zap"
)

// Service handles business logic for CustomerInvoiceLines
type Service struct {
	repo   *customer_invoice_line.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new CustomerInvoiceLines service
func NewService(repo *customer_invoice_line.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateCustomerInvoiceLinesRequest) (*dto.CustomerInvoiceLinesResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.CustomerInvoiceLinesResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.CustomerInvoiceLinesListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.CustomerInvoiceLinesResponse, len(entities))
	...
	return &dto.CustomerInvoiceLinesListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateCustomerInvoiceLinesRequest) (*dto.CustomerInvoiceLinesResponse, error) {
...
func (s *Service) entityToResponse(entity *customer_invoice_line.CustomerInvoiceLines) *dto.CustomerInvoiceLinesResponse {
	return &dto.CustomerInvoiceLinesResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *customer_invoice_line.CustomerInvoiceLines) error {
