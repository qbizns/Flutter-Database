...
// @Param request body CreateCustomerInvoiceLinesRequest true "CustomerInvoiceLines data"
// @Success 201 {object} CustomerInvoiceLinesResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateCustomerInvoiceLinesRequest
...
// @Success 200 {object} CustomerInvoiceLinesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} CustomerInvoiceLinesListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "CustomerInvoiceLines ID"
// @Param request body UpdateCustomerInvoiceLinesRequest true "CustomerInvoiceLines data"
// @Success 200 {object} CustomerInvoiceLinesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateCustomerInvoiceLinesRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
