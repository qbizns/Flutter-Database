...
// @Param request body CreateInventoryTransferItemsRequest true "InventoryTransferItems data"
// @Success 201 {object} InventoryTransferItemsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateInventoryTransferItemsRequest
...
// @Success 200 {object} InventoryTransferItemsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} InventoryTransferItemsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "InventoryTransferItems ID"
// @Param request body UpdateInventoryTransferItemsRequest true "InventoryTransferItems data"
// @Success 200 {object} InventoryTransferItemsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateInventoryTransferItemsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
