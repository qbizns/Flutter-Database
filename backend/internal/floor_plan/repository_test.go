...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateFloorPlansRequest{
...
func newTestFloorPlansRequest(orgID uuid.UUID) *CreateFloorPlansRequest {
	return &CreateFloorPlansRequest{
