...
import (
	...
	"github.com/your-org/pos-backend/internal/service/expens"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for Expenses
type Handler struct {
	service *expens.Service
	logger  *logging.Logger
}

// NewHandler creates a new Expenses handler
func NewHandler(service *expens.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreateExpensesRequest true "Expenses data"
// @Success 201 {object} dto.ExpensesResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreateExpensesRequest
...
// @Success 200 {object} dto.ExpensesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.ExpensesListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "Expenses ID"
// @Param request body dto.UpdateExpensesRequest true "Expenses data"
// @Success 200 {object} dto.ExpensesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdateExpensesRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
