...
func TestService_Create(t *testing.T) {
	...
	req := &CreateRestaurantTablesRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateRestaurantTablesRequest{
	...
	var resp RestaurantTablesResponse
...
func newTestRestaurantTablesRequest(orgID uuid.UUID) *CreateRestaurantTablesRequest {
	return &CreateRestaurantTablesRequest{
