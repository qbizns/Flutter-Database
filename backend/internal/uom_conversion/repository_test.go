...
func TestRepository_Create(t *testing.T) {
	repo := uom_conversion.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestUomConversions(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestUomConversionsWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestUomConversionsRequest()
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestUomConversionsRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/uom_conversions", strings.NewReader(string(body)))
...
// newTestUomConversions creates a test UomConversions entity
func newTestUomConversions() *uom_conversion.UomConversions {
	return &uom_conversion.UomConversions{
...
// newTestUomConversionsWithID creates a test UomConversions entity with specific ID
func newTestUomConversionsWithID(id uuid.UUID) *uom_conversion.UomConversions {
	entity := newTestUomConversions()
	entity.ID = id
	return entity
}
