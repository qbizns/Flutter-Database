...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateCashDrawerSessionsRequest) (*dto.CashDrawerSessionsResponse, error) {
	...
	if err := s.repo.Create(ctx, tx, entity); err != nil {
		return nil, fmt.Errorf("failed to create cash_drawer_sessions: %w", err)
	}
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.CashDrawerSessionsListResponse, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("failed to list cash_drawer_sessions: %w", err)
	}
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateCashDrawerSessionsRequest) (*dto.CashDrawerSessionsResponse, error) {
	...
	if err := s.repo.Update(ctx, tx, entity); err != nil {
		return nil, fmt.Errorf("failed to update cash_drawer_sessions: %w", err)
	}
	...
	s.logger.Info("updated cash_drawer_sessions",
		zap.String("id", id.String()),
		zap.String("organization_id", orgID.String()),
	)
...
// Delete deletes a cash_drawer_sessions
func (s *Service) Delete(ctx context.Context, orgID uuid.UUID, id uuid.UUID) error {
	s.logger.Info("deleting cash_drawer_sessions",
		zap.String("id", id.String()),
		zap.String("organization_id", orgID.String()),
	)
	...
	s.logger.Info("deleted cash_drawer_sessions",
		zap.String("id", id.String()),
		zap.String("organization_id", orgID.String()),
	)
...
// canDelete checks if a cash_drawer_sessions can be deleted
