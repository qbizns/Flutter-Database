...
func RegisterRoutes(r chi.Router, handler *Handler) {
	...
	r.Route("/api/v1/organizations/{orgID}/orders", func(r chi.Router) {
		// Apply middleware
...
// RegisterPublicRoutes registers public Orders routes (if any)
func RegisterPublicRoutes(r chi.Router, handler *Handler) {
	r.Route("/api/v1/public/orders", func(r chi.Router) {
		r.Use(// middlewares.RateLimiter)
		r.Use(middleware.Compress(5))
...
// RegisterAdminRoutes registers admin-only Orders routes
