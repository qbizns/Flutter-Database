package bank_statement_line_test
...
func TestRepository_Create(t *testing.T) {
	repo := bank_statement_line.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestBankStatementLines(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestBankStatementLinesWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestBankStatementLinesRequest()
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestBankStatementLinesRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/bank_statement_lines", strings.NewReader(string(body)))
...
// newTestBankStatementLines creates a test BankStatementLines entity
func newTestBankStatementLines() *bank_statement_line.BankStatementLines {
	return &bank_statement_line.BankStatementLines{
...
// newTestBankStatementLinesWithID creates a test BankStatementLines entity with specific ID
func newTestBankStatementLinesWithID(id uuid.UUID) *bank_statement_line.BankStatementLines {
	entity := newTestBankStatementLines()
	entity.ID = id
	return entity
}
