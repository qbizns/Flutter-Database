...
import (
	...
	"github.com/your-org/pos-backend/internal/service/price_list"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for PriceLists
type Handler struct {
	service *price_list.Service
	logger  *logging.Logger
}

// NewHandler creates a new PriceLists handler
func NewHandler(service *price_list.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreatePriceListsRequest true "PriceLists data"
// @Success 201 {object} dto.PriceListsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreatePriceListsRequest
...
// @Success 200 {object} dto.PriceListsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.PriceListsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "PriceLists ID"
// @Param request body dto.UpdatePriceListsRequest true "PriceLists data"
// @Success 200 {object} dto.PriceListsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdatePriceListsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
