...
func TestService_Create(t *testing.T) {
	...
	req := &CreateAnalyticPlansRequest{
...
func TestService_Update(t *testing.T) {
	...
	updateReq := &UpdateAnalyticPlansRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateAnalyticPlansRequest{
	...
	var resp AnalyticPlansResponse
...
func newTestAnalyticPlansRequest(orgID uuid.UUID) *CreateAnalyticPlansRequest {
	return &CreateAnalyticPlansRequest{
