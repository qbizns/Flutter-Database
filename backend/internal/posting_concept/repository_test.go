...
func TestService_Create(t *testing.T) {
	...
	req := &CreatePostingConceptsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreatePostingConceptsRequest{
	...
	var resp PostingConceptsResponse
...
func newTestPostingConceptsRequest() *CreatePostingConceptsRequest {
	return &CreatePostingConceptsRequest{
