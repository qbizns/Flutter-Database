...
// Validator handles PurchaseOrderItems validation logic
type Validator struct {
	repo *Repository
}

// NewValidator creates a new PurchaseOrderItems validator
...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *dto.CreatePurchaseOrderItemsRequest) error {
	// Basic validation
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *dto.UpdatePurchaseOrderItemsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
	...
	// Validate QuantityOrdered if provided
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *dto.CreatePurchaseOrderItemsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *dto.CreatePurchaseOrderItemsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *PurchaseOrderItems, req *dto.UpdatePurchaseOrderItemsRequest) error {
...
func (v *Validator) validateCanDelete(ctx context.Context, tx pgx.Tx, entity *PurchaseOrderItems) error {
