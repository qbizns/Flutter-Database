...
import (
	...
	"github.com/your-org/pos-backend/internal/service/posting_rule"
	"go.uber.org/zap"
)

// Handler handles HTTP requests for PostingRules
type Handler struct {
	service *posting_rule.Service
	logger  *logging.Logger
}

// NewHandler creates a new PostingRules handler
func NewHandler(service *posting_rule.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreatePostingRulesRequest true "PostingRules data"
// @Success 201 {object} dto.PostingRulesResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreatePostingRulesRequest
...
// @Success 200 {object} dto.PostingRulesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.PostingRulesListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "PostingRules ID"
// @Param request body dto.UpdatePostingRulesRequest true "PostingRules data"
// @Success 200 {object} dto.PostingRulesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdatePostingRulesRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
