...
// @Param request body CreateAssetDepreciationScheduleRequest true "AssetDepreciationSchedule data"
// @Success 201 {object} AssetDepreciationScheduleResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateAssetDepreciationScheduleRequest
...
// @Success 200 {object} AssetDepreciationScheduleResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} AssetDepreciationScheduleListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "AssetDepreciationSchedule ID"
// @Param request body UpdateAssetDepreciationScheduleRequest true "AssetDepreciationSchedule data"
// @Success 200 {object} AssetDepreciationScheduleResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateAssetDepreciationScheduleRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
