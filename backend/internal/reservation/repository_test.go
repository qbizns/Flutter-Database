...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateReservationsRequest{
...
func newTestReservationsRequest(orgID uuid.UUID) *CreateReservationsRequest {
	return &CreateReservationsRequest{
