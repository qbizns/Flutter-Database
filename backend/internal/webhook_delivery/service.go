...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/webhook_delivery"
	"go.uber.org/zap"
)

// Service handles business logic for WebhookDeliveries
type Service struct {
	repo   *webhook_delivery.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new WebhookDeliveries service
func NewService(repo *webhook_delivery.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateWebhookDeliveriesRequest) (*dto.WebhookDeliveriesResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.WebhookDeliveriesResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.WebhookDeliveriesListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.WebhookDeliveriesResponse, len(entities))
	...
	return &dto.WebhookDeliveriesListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateWebhookDeliveriesRequest) (*dto.WebhookDeliveriesResponse, error) {
...
func (s *Service) entityToResponse(entity *webhook_delivery.WebhookDeliveries) *dto.WebhookDeliveriesResponse {
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *webhook_delivery.WebhookDeliveries) error {
