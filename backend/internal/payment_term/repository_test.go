...
func TestService_Update(t *testing.T) {
	...
	updateReq := &UpdatePaymentTermsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreatePaymentTermsRequest{
...
func newTestPaymentTermsRequest(orgID uuid.UUID) *CreatePaymentTermsRequest {
	return &CreatePaymentTermsRequest{
