...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *dto.CreatePosAccountMappingsRequest) error {
	// Basic validation
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *dto.UpdatePosAccountMappingsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *dto.CreatePosAccountMappingsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *dto.CreatePosAccountMappingsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *PosAccountMappings, req *dto.UpdatePosAccountMappingsRequest) error {
