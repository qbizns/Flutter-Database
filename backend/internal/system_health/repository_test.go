...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateSystemHealthRequest{
...
func newTestSystemHealthRequest(orgID uuid.UUID) *CreateSystemHealthRequest {
	return &CreateSystemHealthRequest{
