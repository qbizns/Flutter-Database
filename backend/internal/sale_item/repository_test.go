...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateSaleItemsRequest{
...
func newTestSaleItemsRequest(orgID uuid.UUID) *CreateSaleItemsRequest {
	return &CreateSaleItemsRequest{
