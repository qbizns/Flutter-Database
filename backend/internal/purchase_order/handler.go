...
import (
	...
	"github.com/your-org/pos-backend/internal/service/purchase_order"
	"go.uber.org/zap"
)
...
func NewHandler(service *purchase_order.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreatePurchaseOrdersRequest true "PurchaseOrders data"
// @Success 201 {object} dto.PurchaseOrdersResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreatePurchaseOrdersRequest
...
// @Success 200 {object} dto.PurchaseOrdersResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} dto.PurchaseOrdersListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "PurchaseOrders ID"
// @Param request body dto.UpdatePurchaseOrdersRequest true "PurchaseOrders data"
// @Success 200 {object} dto.PurchaseOrdersResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.UpdatePurchaseOrdersRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
