...
import (
	...
	"github.com/your-org/pos-backend/internal/dto/purchase_order"
	"github.com/your-org/pos-backend/internal/logging"
	"github.com/your-org/pos-backend/internal/repository/purchase_order"
	"go.uber.org/zap"
)

// Service handles business logic for PurchaseOrders
type Service struct {
	repo   *purchase_order.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new PurchaseOrders service
func NewService(repo *purchase_order.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreatePurchaseOrdersRequest) (*dto.PurchaseOrdersResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.PurchaseOrdersResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.PurchaseOrdersListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.PurchaseOrdersResponse, len(entities))
	...
	return &dto.PurchaseOrdersListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdatePurchaseOrdersRequest) (*dto.PurchaseOrdersResponse, error) {
...
func (s *Service) entityToResponse(entity *purchase_order.PurchaseOrders) *dto.PurchaseOrdersResponse {
	return &dto.PurchaseOrdersResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *purchase_order.PurchaseOrders) error {
