...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/customer_invoice"
	"go.uber.org/zap"
)

// Service handles business logic for CustomerInvoices
type Service struct {
	repo   *customer_invoice.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new CustomerInvoices service
func NewService(repo *customer_invoice.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateCustomerInvoicesRequest) (*dto.CustomerInvoicesResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.CustomerInvoicesResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.CustomerInvoicesListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.CustomerInvoicesResponse, len(entities))
	...
	return &dto.CustomerInvoicesListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateCustomerInvoicesRequest) (*dto.CustomerInvoicesResponse, error) {
...
func (s *Service) entityToResponse(entity *customer_invoice.CustomerInvoices) *dto.CustomerInvoicesResponse {
	return &dto.CustomerInvoicesResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *customer_invoice.CustomerInvoices) error {
