...
func TestService_Create(t *testing.T) {
	...
	req := &CreateVendorBillLinesRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateVendorBillLinesRequest{
	...
	var resp VendorBillLinesResponse
...
func newTestVendorBillLinesRequest(orgID uuid.UUID) *CreateVendorBillLinesRequest {
	return &CreateVendorBillLinesRequest{
