...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateOrderItemsRequest{
...
func newTestOrderItemsRequest(orgID uuid.UUID) *CreateOrderItemsRequest {
