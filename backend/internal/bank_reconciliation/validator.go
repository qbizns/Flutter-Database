...
// Validator handles BankReconciliations validation logic
type Validator struct {
	repo *Repository
}

// NewValidator creates a new BankReconciliations validator
...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *dto.CreateBankReconciliationsRequest) error {
	// Basic validation
	...
	// Validate ReconciliationDate
	
	
	
	// Validate BookBalance
	
	
	
	// Validate ClearedBalance
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *dto.UpdateBankReconciliationsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
	...
	// Validate ReconciliationDate if provided
	
	
	
	// Validate BookBalance if provided
	
	
	
	// Validate ClearedBalance if provided
	
	
	
	// Validate Difference if provided
	...
	// Validate ReconciledBy if provided
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *dto.CreateBankReconciliationsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *dto.CreateBankReconciliationsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *BankReconciliations, req *dto.UpdateBankReconciliationsRequest) error {
...
func (v *Validator) validateCanDelete(ctx context.Context, tx pgx.Tx, entity *BankReconciliations) error {
