...
// @Param request body CreateBankReconciliationsRequest true "BankReconciliations data"
// @Success 201 {object} BankReconciliationsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateBankReconciliationsRequest
...
// @Success 200 {object} BankReconciliationsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} BankReconciliationsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "BankReconciliations ID"
// @Param request body UpdateBankReconciliationsRequest true "BankReconciliations data"
// @Success 200 {object} BankReconciliationsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateBankReconciliationsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
