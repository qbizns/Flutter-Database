...
import (
	...
	"github.com/your-org/pos-backend/internal/service/permission"
	"go.uber.org/zap"
)
...
func NewHandler(service *permission.Service, logger *logging.Logger) *Handler {
	return &Handler{
		service: service,
		logger:  logger,
	}
...
// @Param request body dto.CreatePermissionsRequest true "Permissions data"
// @Success 201 {object} dto.PermissionsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req dto.CreatePermissionsRequest
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "Permissions ID"
// @Param request body dto.UpdatePermissionsRequest true "Permissions data"
// @Success 200 {object} dto.PermissionsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
