...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateUserSessionsRequest{
...
func newTestUserSessionsRequest(orgID uuid.UUID) *CreateUserSessionsRequest {
	return &CreateUserSessionsRequest{
