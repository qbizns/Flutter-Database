...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/user_session"
	"go.uber.org/zap"
)

// Service handles business logic for UserSessions
type Service struct {
	repo   *user_session.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new UserSessions service
func NewService(repo *user_session.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateUserSessionsRequest) (*dto.UserSessionsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.UserSessionsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.UserSessionsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.UserSessionsResponse, len(entities))
	...
	return &dto.UserSessionsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateUserSessionsRequest) (*dto.UserSessionsResponse, error) {
...
func (s *Service) entityToResponse(entity *user_session.UserSessions) *dto.UserSessionsResponse {
	return &dto.UserSessionsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *user_session.UserSessions) error {
