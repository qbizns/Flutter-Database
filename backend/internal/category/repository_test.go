...
func TestService_Update(t *testing.T) {
	...
	updateReq := &UpdateCategoriesRequest{
		Name: &updatedValue,
	}
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateCategoriesRequest{
...
func newTestCategoriesRequest(orgID uuid.UUID) *CreateCategoriesRequest {
