...
func TestService_Update(t *testing.T) {
	...
	updateReq := &UpdateLocationsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateLocationsRequest{
...
func newTestLocationsRequest(orgID uuid.UUID) *CreateLocationsRequest {
	return &CreateLocationsRequest{
