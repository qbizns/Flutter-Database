...
// Validator handles PosSessions validation logic
type Validator struct {
	repo *Repository
}

// NewValidator creates a new PosSessions validator
...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *dto.CreatePosSessionsRequest) error {
	// Basic validation
	...
	if err := v.validateSessionNumber(req.SessionNumber); err != nil {
		return err
	}
	...
	// Validate OpeningCash
	
	
	
	// Validate OpeningCard
	
	
	
	// Validate OpeningOther
	
	
	
	// Validate ExpectedCash
	
	
	
	// Validate ExpectedCard
	
	
	
	// Validate ExpectedOther
	
	
	
	// Validate CountedCash
	
	
	
	// Validate CountedCard
	
	
	
	// Validate CountedOther
	
	
	
	// Validate DifferenceCash
	
	
	
	// Validate DifferenceCard
	
	
	
	// Validate DifferenceOther
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *dto.UpdatePosSessionsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
	...
	// Validate OpeningCash if provided
	
	
	
	// Validate OpeningCard if provided
	
	
	
	// Validate OpeningOther if provided
	
	
	
	// Validate ExpectedCash if provided
	
	
	
	// Validate ExpectedCard if provided
	
	
	
	// Validate ExpectedOther if provided
	
	
	
	// Validate CountedCash if provided
	
	
	
	// Validate CountedCard if provided
	
	
	
	// Validate CountedOther if provided
	
	
	
	// Validate DifferenceCash if provided
	
	
	
	// Validate DifferenceCard if provided
	
	
	
	// Validate DifferenceOther if provided
	...
	// Validate ZReportNumber if provided
...
// validateSessionNumber validates session_number field
func (v *Validator) validateSessionNumber(value string) error {
	
	// Add custom validation for session_number
	if strings.TrimSpace(value) == "" {
		return fmt.Errorf("session_number cannot be empty")
	}
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *dto.CreatePosSessionsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *dto.CreatePosSessionsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *PosSessions, req *dto.UpdatePosSessionsRequest) error {
...
func (v *Validator) validateCanDelete(ctx context.Context, tx pgx.Tx, entity *PosSessions) error {
