...
func TestService_Update(t *testing.T) {
	...
	updateReq := &UpdateSmsQueueRequest{
...
func newTestSmsQueueRequest(orgID uuid.UUID) *CreateSmsQueueRequest {
	return &CreateSmsQueueRequest{
