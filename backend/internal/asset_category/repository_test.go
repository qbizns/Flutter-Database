...
func TestRepository_Create(t *testing.T) {
	repo := asset_category.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestAssetCategories(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestAssetCategoriesWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestRepository_Update(t *testing.T) {
	...
	entity.CategoryCode = "updated_value"
	...
	assert.Equal(t, "updated_value", updated.CategoryCode)
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestAssetCategoriesRequest()
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestAssetCategoriesRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/asset_categories", strings.NewReader(string(body)))
...
// newTestAssetCategories creates a test AssetCategories entity
func newTestAssetCategories() *asset_category.AssetCategories {
	return &asset_category.AssetCategories{
...
// newTestAssetCategoriesWithID creates a test AssetCategories entity with specific ID
func newTestAssetCategoriesWithID(id uuid.UUID) *asset_category.AssetCategories {
	entity := newTestAssetCategories()
	entity.ID = id
	return entity
}
