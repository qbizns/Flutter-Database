...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateAuditLogsRequest{
...
func newTestAuditLogsRequest(orgID uuid.UUID) *CreateAuditLogsRequest {
	return &CreateAuditLogsRequest{
