...
// @Param request body CreateReturnReasonsRequest true "ReturnReasons data"
// @Success 201 {object} ReturnReasonsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateReturnReasonsRequest
...
// @Success 200 {object} ReturnReasonsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "ReturnReasons ID"
// @Param request body UpdateReturnReasonsRequest true "ReturnReasons data"
// @Success 200 {object} ReturnReasonsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateReturnReasonsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
