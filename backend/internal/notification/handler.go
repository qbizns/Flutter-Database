...
// @Param request body CreateNotificationsRequest true "Notifications data"
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateNotificationsRequest
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "Notifications ID"
// @Param request body UpdateNotificationsRequest true "Notifications data"
// @Success 200 {object} NotificationsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
