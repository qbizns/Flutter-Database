...
// @Param request body CreatePostingValidationResultsRequest true "PostingValidationResults data"
// @Success 201 {object} PostingValidationResultsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreatePostingValidationResultsRequest
...
// @Success 200 {object} PostingValidationResultsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} PostingValidationResultsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "PostingValidationResults ID"
// @Param request body UpdatePostingValidationResultsRequest true "PostingValidationResults data"
// @Success 200 {object} PostingValidationResultsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdatePostingValidationResultsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
