...
func TestService_Create(t *testing.T) {
	...
	req := &dto.CreateProductVariantsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &dto.CreateProductVariantsRequest{
	...
	var resp dto.ProductVariantsResponse
...
func newTestProductVariantsRequest(orgID uuid.UUID) *dto.CreateProductVariantsRequest {
	return &dto.CreateProductVariantsRequest{
