...
// @Param request body CreateOrderItemModifiersRequest true "OrderItemModifiers data"
// @Success 201 {object} OrderItemModifiersResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateOrderItemModifiersRequest
...
// @Success 200 {object} OrderItemModifiersResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} OrderItemModifiersListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "OrderItemModifiers ID"
// @Param request body UpdateOrderItemModifiersRequest true "OrderItemModifiers data"
// @Success 200 {object} OrderItemModifiersResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateOrderItemModifiersRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
