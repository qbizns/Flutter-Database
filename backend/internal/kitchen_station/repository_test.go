...
func TestService_Create(t *testing.T) {
	...
	req := &CreateKitchenStationsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateKitchenStationsRequest{
	...
	var resp KitchenStationsResponse
...
func newTestKitchenStationsRequest(orgID uuid.UUID) *CreateKitchenStationsRequest {
	return &CreateKitchenStationsRequest{
