...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/kitchen_station"
	"go.uber.org/zap"
)

// Service handles business logic for KitchenStations
type Service struct {
	repo   *kitchen_station.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new KitchenStations service
func NewService(repo *kitchen_station.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateKitchenStationsRequest) (*dto.KitchenStationsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.KitchenStationsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.KitchenStationsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.KitchenStationsResponse, len(entities))
	...
	return &dto.KitchenStationsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateKitchenStationsRequest) (*dto.KitchenStationsResponse, error) {
...
func (s *Service) entityToResponse(entity *kitchen_station.KitchenStations) *dto.KitchenStationsResponse {
	return &dto.KitchenStationsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *kitchen_station.KitchenStations) error {
