...
func TestService_Create(t *testing.T) {
	...
	req := &CreateEInvoicingDocumentsRequest{
...
func TestService_Update(t *testing.T) {
	...
	updateReq := &UpdateEInvoicingDocumentsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateEInvoicingDocumentsRequest{
	...
	var resp EInvoicingDocumentsResponse
...
func newTestEInvoicingDocumentsRequest(orgID uuid.UUID) *CreateEInvoicingDocumentsRequest {
	return &CreateEInvoicingDocumentsRequest{
