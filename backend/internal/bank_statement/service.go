...
import (
	...
	"github.com/your-org/pos-backend/internal/dto/bank_statement"
	"github.com/your-org/pos-backend/internal/logging"
	"github.com/your-org/pos-backend/internal/repository/bank_statement"
	"go.uber.org/zap"
)

// Service handles business logic for BankStatements
type Service struct {
	repo   *bank_statement.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new BankStatements service
func NewService(repo *bank_statement.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateBankStatementsRequest) (*dto.BankStatementsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.BankStatementsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.BankStatementsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.BankStatementsResponse, len(entities))
	...
	return &dto.BankStatementsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateBankStatementsRequest) (*dto.BankStatementsResponse, error) {
...
func (s *Service) entityToResponse(entity *bank_statement.BankStatements) *dto.BankStatementsResponse {
	return &dto.BankStatementsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *bank_statement.BankStatements) error {
