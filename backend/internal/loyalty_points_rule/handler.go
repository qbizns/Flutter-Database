...
// @Param request body CreateLoyaltyPointsRulesRequest true "LoyaltyPointsRules data"
// @Success 201 {object} LoyaltyPointsRulesResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateLoyaltyPointsRulesRequest
...
// @Success 200 {object} LoyaltyPointsRulesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} LoyaltyPointsRulesListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "LoyaltyPointsRules ID"
// @Param request body UpdateLoyaltyPointsRulesRequest true "LoyaltyPointsRules data"
// @Success 200 {object} LoyaltyPointsRulesResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateLoyaltyPointsRulesRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
