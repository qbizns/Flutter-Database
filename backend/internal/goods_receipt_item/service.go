...
import (
	...
	"github.com/your-org/pos-backend/internal/repository/goods_receipt_item"
	"go.uber.org/zap"
)

// Service handles business logic for GoodsReceiptItems
type Service struct {
	repo   *goods_receipt_item.Repository
	db     *pgxpool.Pool
	logger *logging.Logger
}

// NewService creates a new GoodsReceiptItems service
func NewService(repo *goods_receipt_item.Repository, db *pgxpool.Pool, logger *logging.Logger) *Service {
	return &Service{
		repo:   repo,
		db:     db,
		logger: logger,
...
func (s *Service) Create(ctx context.Context, orgID uuid.UUID, req *dto.CreateGoodsReceiptItemsRequest) (*dto.GoodsReceiptItemsResponse, error) {
...
func (s *Service) GetByID(ctx context.Context, orgID uuid.UUID, id uuid.UUID) (*dto.GoodsReceiptItemsResponse, error) {
...
func (s *Service) List(ctx context.Context, orgID uuid.UUID, page, limit int) (*dto.GoodsReceiptItemsListResponse, error) {
	...
	// Convert to response
	items := make([]*dto.GoodsReceiptItemsResponse, len(entities))
	...
	return &dto.GoodsReceiptItemsListResponse{
		Items: items,
...
func (s *Service) Update(ctx context.Context, orgID uuid.UUID, id uuid.UUID, req *dto.UpdateGoodsReceiptItemsRequest) (*dto.GoodsReceiptItemsResponse, error) {
...
func (s *Service) entityToResponse(entity *goods_receipt_item.GoodsReceiptItems) *dto.GoodsReceiptItemsResponse {
	return &dto.GoodsReceiptItemsResponse{
...
func (s *Service) validateBusinessRules(ctx context.Context, tx pgx.Tx, entity *goods_receipt_item.GoodsReceiptItems) error {
