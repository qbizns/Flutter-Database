...
func TestService_Create(t *testing.T) {
	...
	req := &CreateGoodsReceiptItemsRequest{
...
func TestHandler_Create(t *testing.T) {
	...
	reqBody := &CreateGoodsReceiptItemsRequest{
	...
	var resp GoodsReceiptItemsResponse
...
func newTestGoodsReceiptItemsRequest(orgID uuid.UUID) *CreateGoodsReceiptItemsRequest {
	return &CreateGoodsReceiptItemsRequest{
