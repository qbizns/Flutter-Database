...
// @Param request body CreateGoodsReceiptItemsRequest true "GoodsReceiptItems data"
// @Success 201 {object} GoodsReceiptItemsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateGoodsReceiptItemsRequest
...
// @Success 200 {object} GoodsReceiptItemsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} GoodsReceiptItemsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "GoodsReceiptItems ID"
// @Param request body UpdateGoodsReceiptItemsRequest true "GoodsReceiptItems data"
// @Success 200 {object} GoodsReceiptItemsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateGoodsReceiptItemsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
