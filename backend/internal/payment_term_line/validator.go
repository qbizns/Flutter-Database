...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *CreatePaymentTermLinesRequest) error {
	// Basic validation
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *UpdatePaymentTermLinesRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *CreatePaymentTermLinesRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *CreatePaymentTermLinesRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *PaymentTermLines, req *UpdatePaymentTermLinesRequest) error {
