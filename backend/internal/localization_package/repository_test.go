package localization_package_test
...
func TestRepository_Create(t *testing.T) {
	repo := localization_package.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestLocalizationPackages(),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestLocalizationPackagesWithID(uuid.New()),
			wantErr: true,
		},
	}
...
func TestRepository_Update(t *testing.T) {
	...
	entity.PackageCode = "updated_value"
	...
	assert.Equal(t, "updated_value", updated.PackageCode)
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestLocalizationPackagesRequest()
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestLocalizationPackagesRequest()
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/localization_packages", strings.NewReader(string(body)))
...
// newTestLocalizationPackages creates a test LocalizationPackages entity
func newTestLocalizationPackages() *localization_package.LocalizationPackages {
	return &localization_package.LocalizationPackages{
...
// newTestLocalizationPackagesWithID creates a test LocalizationPackages entity with specific ID
func newTestLocalizationPackagesWithID(id uuid.UUID) *localization_package.LocalizationPackages {
	entity := newTestLocalizationPackages()
	entity.ID = id
	return entity
}
