...
func TestRepository_Create(t *testing.T) {
	repo := webhook.NewRepository(testDB, testLogger)
	...
	tests := []struct {
		...
		{
			name:    "valid entity",
			entity:  newTestWebhooks(testOrgID),
			wantErr: false,
		},
		{
			name:    "duplicate primary key",
			entity:  newTestWebhooksWithID(uuid.New(), testOrgID),
			wantErr: true,
		},
	}
...
func TestRepository_Update(t *testing.T) {
	...
	entity.WebhookName = "updated_value"
	...
	assert.Equal(t, "updated_value", updated.WebhookName)
...
func TestRepository_ListByOrganization(t *testing.T) {
	...
	otherOrgID := uuid.New()
	for i := 0; i < 2; i++ {
		entity := newTestWebhooks(otherOrgID)
		err := repo.Create(ctx, tx, entity)
		require.NoError(t, err)
	}
...
func TestService_GetByID(t *testing.T) {
	...
	// Create test entity
	req := newTestWebhooksRequest(testOrgID)
...
func TestService_Update(t *testing.T) {
	...
	// Create test entity
	createReq := newTestWebhooksRequest(testOrgID)
...
func TestHandler_Create(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodPost, "/api/v1/organizations/"+testOrgID.String()+"/webhooks", strings.NewReader(string(body)))
...
// newTestWebhooks creates a test Webhooks entity
func newTestWebhooks(orgID uuid.UUID) *webhook.Webhooks {
...
// newTestWebhooksWithID creates a test Webhooks entity with specific ID
func newTestWebhooksWithID(id uuid.UUID, orgID uuid.UUID) *webhook.Webhooks {
	entity := newTestWebhooks(orgID)
	entity.ID = id
	return entity
}
