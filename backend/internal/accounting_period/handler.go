...
// @Param request body CreateAccountingPeriodsRequest true "AccountingPeriods data"
// @Success 201 {object} AccountingPeriodsResponse
...
func (h *Handler) Create(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req CreateAccountingPeriodsRequest
...
// @Success 200 {object} AccountingPeriodsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
...
// @Success 200 {object} AccountingPeriodsListResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 500 {object} ErrorResponse
...
// @Param orgID path string true "Organization ID"
// @Param id path string true "AccountingPeriods ID"
// @Param request body UpdateAccountingPeriodsRequest true "AccountingPeriods data"
// @Success 200 {object} AccountingPeriodsResponse
// @Failure 400 {object} ErrorResponse
// @Failure 401 {object} ErrorResponse
// @Failure 404 {object} ErrorResponse
...
func (h *Handler) Update(w http.ResponseWriter, r *http.Request) {
	...
	// Parse request body
	var req UpdateAccountingPeriodsRequest
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
		h.respondError(w, http.StatusBadRequest, "invalid request body", err)
		return
	}
