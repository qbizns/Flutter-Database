...
func (v *Validator) ValidateCreate(ctx context.Context, tx pgx.Tx, req *CreateGoodsReceiptsRequest) error {
	// Basic validation
...
func (v *Validator) ValidateUpdate(ctx context.Context, tx pgx.Tx, id uuid.UUID, req *UpdateGoodsReceiptsRequest) error {
	// Basic validation
	if err := req.Validate(); err != nil {
		return fmt.Errorf("validation failed: %w", err)
	}
...
func (v *Validator) validateCrossFields(ctx context.Context, tx pgx.Tx, req *CreateGoodsReceiptsRequest) error {
...
func (v *Validator) validateBusinessRules(ctx context.Context, tx pgx.Tx, req *CreateGoodsReceiptsRequest) error {
...
func (v *Validator) validateUpdateBusinessRules(ctx context.Context, tx pgx.Tx, existing *GoodsReceipts, req *UpdateGoodsReceiptsRequest) error {
